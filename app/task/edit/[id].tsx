...
export default function EditTaskScreen() {
  ...
  const { tasks, categories, updateTask, getCurrentTheme } = useAppStore();
  ...
  const [locationOption, setLocationOption] = useState<LocationOption>(task?.location_reminder as LocationOption || 'none');
  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor: currentTheme.background }]}>
      ...
      >
        ...
        {/* Save button - Fixed position that stays visible with keyboard */}
        <TouchableOpacity 
          style={[
            styles.saveButton,
            keyboardVisible && styles.saveButtonKeyboard
          ]}
